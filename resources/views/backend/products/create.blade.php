...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
            <div class="col-md-12">
            <form action="{{ route('backend.products.store') }}" method="POST" id="addForm">
                @csrf
            <!-- Default box -->            
            <div class="card card-success card-outline">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row required">
                        ...
                        <div class="col-sm-10">
                            <textarea id="detail" class="form-control @error('detail') is-invalid @enderror" rows="5" name="detail" placeholder="Detail">{{ old('detail') }}</textarea>
                            @error('detail')
                                <span class="error invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
