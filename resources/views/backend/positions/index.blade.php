        ...
        <section class="content">
            ...
            <div class="container-fluid">
                <div class="row text-right mb-1">
                    <div class="col-12">                        
                        <a class="btn btn-success" href="{{ route('backend.positions.create') }}"><i class="fas fa-plus"></i> Add</a>
                    </div>
                </div>
            <div class="row">
            <div class="col-12">
            ...
            <div class="card card-default card-outline">
                <div class="card-header">
                    <h3 class="card-title">List Positions</h3>
...
@section('scripts')
<script src="{{ asset('js/backend/positions/index.js') }}"></script>
@endsection