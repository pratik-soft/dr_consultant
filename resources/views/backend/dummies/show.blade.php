                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info card-outline">
                            <div class="card-header">
                                <h3 class="card-title">View Dummy</h3>
                            ...
                            <div class="card-body">
                                <dl class="row">
                                    ...
                                    <dd class="col-sm-8">{{ $dummy->id }}</dd>
                                    <dt class="col-sm-4">Name</dt>
                                    <dd class="col-sm-8">{{ $dummy->name }}</dd>
                                    <dt class="col-sm-4">Description</dt>
                                    <dd class="col-sm-8">{{ $dummy->description }}</dd>
                                    <dt class="col-sm-4">Created At</dt>
                                    <dd class="col-sm-8">{!! getDatetimeHtml($dummy->created_at,'success') !!}</dd>
                                    <dt class="col-sm-4">Updated At</dt>
                                    <dd class="col-sm-8">{!! getDatetimeHtml($dummy->updated_at,'primary') !!}</dd>
                                </dl>
                            </div>
                            <!-- /.card-body -->
