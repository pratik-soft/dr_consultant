...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
            <div class="col-md-12">
            <form action="{{ route('backend.testimonials.store') }}" method="POST" id="addForm" enctype="multipart/form-data">
                @csrf
            <!-- Default box -->            
            <div class="card card-success card-outline">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row required">
                        ...
                        <div class="col-sm-10">
                            <textarea id="review" class="form-control @error('review') is-invalid @enderror" rows="5" name="review" placeholder="Review">{{ old('review') }}</textarea>
                            @error('review')
                                <span class="error invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
...
@section('scripts')
<script src="{{ asset('js/backend/testimonials/create.js') }}"></script>
@endsection