        ...
        <section class="content">
            ...
            <div class="container-fluid">
                <div class="row text-right mb-1">
                    <div class="col-12">                        
                        <a class="btn btn-success" href="{{ route('backend.subscribers.create') }}"><i class="fas fa-plus"></i> Add</a>
                    </div>
                </div>
            <div class="row">
            <div class="col-12">
            ...
            <div class="card card-default card-outline">
                <div class="card-header">
                    <h3 class="card-title">List Subscribers</h3>
...
@section('scripts')
<script src="{{ asset('js/backend/subscribers/index.js') }}"></script>
@endsection