...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form action="{{ route('backend.permissions.update',$permission->id) }}" method="POST" id="editForm">
                @csrf
                @method('PUT') 
            <!-- Default box -->
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <div class="form-group row required">
                        ...
                        <div class="col-sm-10">                            
                            <input id="name" type="text" name="name" value="{{ $permission->name }}" class="form-control  @error('name') is-invalid @enderror" placeholder="Name">
                            @error('name')
...
@section('scripts')
<script src="{{ asset('js/backend/permissions/edit.js') }}"></script>
@endsection