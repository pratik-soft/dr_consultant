...
<div class="wrapper">
    ...
    @include('partials.backend.aside', ['asideSelected' => 'tags'])
    ...
    <div class="content-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('backend.tags.index') }}">Tags</a></li>
        ...
        <section class="content">
            ...
            <div class="row">
            <div class="col-md-12">
            <form action="{{ route('backend.tags.store') }}" method="POST" id="addForm">
                @csrf
            <!-- Default box -->            
            <div class="card card-success card-outline">
                ...
                <div class="card-footer">                    
                    <a type="button" class="btn btn-default" href="{{ route('backend.tags.index') }}"><i class="fas fa-times-circle"></i> Cancel</a>
...
@section('scripts')
<script src="{{ asset('js/backend/tags/create.js') }}"></script>
@endsection