...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form action="{{ route('backend.team.update',$team->id) }}" method="POST" id="editForm" enctype="multipart/form-data">
                @csrf
                @method('PUT') 
            <!-- Default box -->
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <div class="form-group row required">
                        ...
                        <div class="col-sm-10">                            
                            <input type="text" name="fullname" value="{{ $team->fullname }}" class="form-control  @error('fullname') is-invalid @enderror" placeholder="Full Name">
                            @error('fullname')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <img class="img-thumbnail mb-2" src="{{ getTeamPhoto($team->photo) }}" style="height:100px">                            
                            <input type="file" name="photo" value="{{ $team->photo }}" class="form-control  @error('photo') is-invalid @enderror" placeholder="photo">
                            @error('photo')
                                <span class="error invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">                            
                            <select name="position_id" id="position_id" class="form-control">                                
                                ...
                                {
                                    ?><option value="<?php echo $key; ?>" <?php if($team->position_id == $key){?> selected="selected"<?php } ?>><?php echo $val; ?></option><?php
                                }
                                ?>
                            </select>
                            @error('position_id')
...
@section('scripts')
<script src="{{ asset('js/backend/team/edit.js') }}"></script>
@endsection