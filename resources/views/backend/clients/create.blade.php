...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
            <div class="col-md-12">
            <form action="{{ route('backend.clients.store') }}" method="POST" id="addForm" enctype="multipart/form-data">
                @csrf
            <!-- Default box -->            
            <div class="card card-success card-outline">
                ...
                <div class="card-body">
                    <div class="form-group row required">
                        ...
                        <div class="col-sm-10">                            
                            <input id="logo" type="file" name="logo" value="{{ old('logo') }}" class="form-control @error('logo') is-invalid @enderror" placeholder="Logo" accept="image/*">
                            @error('logo')
...
@section('scripts')
<script src="{{ asset('js/backend/clients/create.js') }}"></script>
@endsection