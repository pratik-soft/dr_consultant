...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
            <div class="col-md-12">
            <form action="{{ route('backend.roles.store') }}" method="POST" id="addForm">
                @csrf
            <!-- Default box -->            
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="row">                                
                                ...
                                @if (strpos($value->name, 'blog-') !== false && !in_array('blog-', $rolePrefixes))
                                    ...
                                    @endif
                                    <div class="col-md-3">
                                        <input type="checkbox" class="form-check-input1" id="role-{{ $value->id }}" name="permission[]" value="{{ $value->id }}">
...
@section('scripts')
<script src="{{ asset('js/backend/roles/create.js') }}"></script>
@endsection