...
@section('meta_description', 'Terms and Conditions')
@section('meta_keywords', 'Terms and Conditions')
        ...
        <div class="container">
            <div class="row justify-content-center" data-aos="fade-up">
                <div class="col-lg-10">
                    ...
                    <p>These terms and conditions outline the rules and regulations for the use of Your Company Name's
                        Website,
                        located at http://www.example.com.</p>

                    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                        Your
                        Website Name if you do not agree to take all of the terms and conditions stated on this page.
                    </p>
                    ...
                    <p>We employ the use of cookies. By accessing Your Website Name, you agreed to use cookies in
                        agreement with the
                        Your Company Name's Privacy Policy. </p>
                    ...
                    <p>Unless otherwise stated, Your Company Name and/or its licensors own the intellectual property
                        rights for all
                        material on Your Website Name. All intellectual property rights are reserved. You may access
                        this from Your
                    ...
                    <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                        ...
                        areas of the website. Your Company Name does not filter, edit, publish or review Comments prior
                        to their
                        presence on the website. Comments do not reflect the views and opinions of Your Company Name,its
                        agents
                        and/or affiliates. Comments reflect the views and opinions of the person who post their views
                        and opinions.
                        To the extent permitted by applicable laws, Your Company Name shall not be liable for the
                        Comments or for
                    ...
                    <p>Your Company Name reserves the right to monitor all Comments and to remove any Comments which can
                        be
                    ...
                    <p>You hereby grant Your Company Name a non-exclusive license to use, reproduce, edit and authorize
                        others to
                    ...
                    <p>We will approve link requests from these organizations if we decide that: (a) the link would not
                        ...
                        absence of Your
                        Company Name; and (d) the link is in the context of general resource information.</p>
                    ...
                    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to
                        our website,
                        you must inform us by sending an e-mail to Your Company Name. Please include your name, your
                        organization
                        name, contact information as well as the URL of your site, a list of any URLs from which you
                        intend to link
                        to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3
                        weeks for a
                        response.</p>
                    ...
                    <p>No use of Your Company Name's logo or other artwork will be allowed for linking absent a
                        trademark license
                        agreement.</p>
