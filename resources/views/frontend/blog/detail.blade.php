...
@section('meta_keywords', 'Blog Detail')
                    ...
                    <article class="entry entry-single" data-aos="fade-up">
                        ...
                        <div class="entry-meta">
                            <ul>
                                ...
                                <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href="blog-single.html"><time datetime="2020-01-01">{{ $blog->posted_at->diffForHumans() }}</time></a></li>
